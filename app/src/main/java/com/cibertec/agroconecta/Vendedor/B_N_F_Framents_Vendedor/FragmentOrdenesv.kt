...
import com.cibertec.agroconecta.Adaptadores.AdapOrdenv
import com.cibertec.agroconecta.Modelos.ModeloOrden
import com.cibertec.agroconecta.databinding.FragmentOrdenesvBinding
...
class FragmentOrdenesv : Fragment() {
    ...
    private lateinit var ordenAdaptador : AdapOrdenv
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.IbFiltro.setOnClickListener {
            filtrarOrdenMenu()
        }
    ...
    private fun verOrdenes() {
        ...
        ref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                ordenAdaptador = AdapOrdenv(mContext, ordenesArrayList)
    ...
    private fun filtrarOrdenMenu() {
        val popupMenu = PopupMenu(mContext , binding.IbFiltro)
        ...
        ref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (ds in snapshot.children){
                    ...
                    val modeloOrden = ds.getValue(ModeloOrden::class.java)
