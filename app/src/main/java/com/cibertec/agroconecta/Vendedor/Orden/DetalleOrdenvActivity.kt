package com.cibertec.agroconecta.Vendedor.Orden
...
import com.cibertec.agroconecta.Adaptadores.AdapProductoOrden
...
import com.cibertec.agroconecta.databinding.ActivityDetalleOrdenvBinding
...
class DetalleOrdenvActivity : AppCompatActivity() {
    ...
    private lateinit var productosArrayList : ArrayList<ModeloOrdenProducto>
    private lateinit var productoOrdenAdaptador : AdapProductoOrden
        ...
        ref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (ds in snapshot.children){
                    val modeloProductoOrden = ds.getValue(ModeloOrdenProducto::class.java)
                    productosArrayList.add(modeloProductoOrden!!)
                }

                productoOrdenAdaptador = AdapProductoOrden(this@DetalleOrdenvActivity, productosArrayList)
    ...
    private fun datosOrden(){
        ...
        ref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                costo = "${snapshot.child("totalOrden").value}"
    ...
    private fun infoCliente(uidCliente: String) {
        ...
        dialog.setContentView(R.layout.info_cliente)

        ivPerfil = dialog.findViewById(R.id.ivPerfil)
        tvNombresC = dialog.findViewById(R.id.tNombresC)
        tvDniC = dialog.findViewById(R.id.tDniC)
        tvTelC = dialog.findViewById(R.id.tTelC)
        tvDireccionC = dialog.findViewById(R.id.tDirC)
        ...
        //se aplico esto para llamarCliente
    ...
    private val permisoLlamar = registerForActivityResult(ActivityResultContracts.RequestPermission()){concedido->
            if (concedido){
                llamarCliente(telefono)
            }else{
