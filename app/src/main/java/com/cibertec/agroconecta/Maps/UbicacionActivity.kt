package com.cibertec.agroconecta.Maps
...
import com.cibertec.agroconecta.databinding.ActivityUbicacionBinding
...
class UbicacionActivity : AppCompatActivity() , OnMapReadyCallback{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.listUbi.visibility = View.GONE

        val mapFragment = supportFragmentManager.findFragmentById(R.id.Mapf) as SupportMapFragment
        mapFragment.getMapAsync(this)

        Places.initialize(this, getString(R.string.keymaps))
        ...
        binding.Imgbgps.setOnClickListener {
            if (isGpsActivated()){
        ...
        binding.btnUbiConfirmar.setOnClickListener {
            val intent = Intent()
    ...
    private fun addMarker(latlng : LatLng, titulo : String , direccion : String){
        ...
        try {
            ...
            mMap!!.moveCamera(CameraUpdateFactory.newLatLngZoom(latlng,DEFAULT_ZOOM.toFloat()))
            binding.listUbi.visibility = View.VISIBLE
            binding.lstv.text = direccion
